                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-10 text-left">
                            <p>
                                ...
                                <i>Author</i>: beatzz
                                <br />
                                <i>About</i>: A simple Java GUI application to
                                convert measurements from one unit type to
                                another.
                                <br />
                                <i>Windows</i>:{' '}
                                <a
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-10 text-left">
                            <p>
                                ...
                                <i>Author</i>: beatzz
                                <br />
                                <i>About</i>: A JavaFX application which will
                                connect to a SQLite database, and dynamically
                                display the tables, columns, and values therein,
                                allowing the user to add, remove, or update
                                entries as well.
                                <br />
                                <i>Windows</i>:{' '}
                                <a
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-10 text-left">
                            <p>
                                ...
                                <i>Author</i>: beatzz
                                <br />
                                <i>About</i>: A console based game of Blackjack
                                written in Java, demonstrating solid Object
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-10 text-left">
                            <p>
                                ...
                                <br />
                                <i>About</i>: A Linux distribution designed with
                                simplicity, stability, and sophistication in
                                mind. Based largely on Slackware Linux,
                                utilizing the power of musl-libc!
                            </p>
                        </div>
                    </div>
                    <br />
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-10 text-left">
                            <p>
                                ...
                                <i>Author</i>: @elsheepo
                                <br />
                                <i>About</i>: Check out my GitHub repositories!
                                There I have a collection of projects I'll be
