          ...
          <Modal.Body>
            <Card>
              <p>
                ...
                <i>registration form</i>. During registration a user is required
                to give certain information (such as name and email address).
                ...
                code, age level). Contact information will be used to notify the
