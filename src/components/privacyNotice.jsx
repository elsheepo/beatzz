  ...
  return (
    <React.Fragment>
      <p>
        <b>Privacy Notice</b>
        <br />
        This privacy notice discloses the privacy practices for <i>beatzz.co</i>
        ...
        the following at any time by contacting us via the <i>
          contact form
        </i>{" "}
        on our website:
        <br />
        ...
        <i>registration form</i>. During registration a user is required to give
